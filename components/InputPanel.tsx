...
const examples = [
    ...
    {
        name: 'نوسانگر واداشته',
        prompt: 'حرکت یک نوسانگر هارمونیک میرا با جرم ۱ کیلوگرم، ثابت فنر ۱۰۰ نیوتن بر متر و ضریب میرایی ۲ نیوتن ثانیه بر متر را تحلیل کنید. این نوسانگر تحت تاثیر یک نیروی خارجی سینوسی F(t) = 10 * cos(5 * t) قرار دارد. جسم از حالت سکون در مبدا رها می‌شود.'
    },
    {
        name: 'تشدید',
        prompt: 'پدیده تشدید را در یک نوسانگر واداشته با میرایی کم بررسی کنید. جرم جسم ۱ کیلوگرم، ثابت فنر ۱۰۰ نیوتن بر متر و ضریب میرایی ۰.۵ نیوتن ثانیه بر متر است. نیروی وادارنده F(t) = 5 * cos(10 * t) است. توجه کنید که فرکانس نیروی وادارنده (۱۰ راد بر ثانیه) به فرکانس طبیعی سیستم بسیار نزدیک است. جسم از حالت سکون در مبدا رها می‌شود.'
    },
    {
        name: 'مدار RL',
        prompt: 'یک مدار RL سری با مقاومت ۱۰ اهم، سلف ۲ هانری و منبع ولتاژ ثابت ۵ ولت را تحلیل کنید. جریان در مدار در لحظه t=0 صفر است.'
    },
    {
        name: 'مدار RC',
        prompt: 'یک مدار RC سری با مقاومت ۵ اهم، خازن ۰.۱ فاراد و منبع ولتاژ ثابت ۱۰ ولت را تحلیل کنید. خازن در لحظه t=0 خالی است.'
    },
    {
        name: 'مدار RLC',
        prompt: 'نوسانات جریان و بار را در یک مدار RLC سری تحلیل کنید. مقاومت R=2 اهم، سلف L=1 هانری و خازن C=0.2 فاراد است. در لحظه t=0، خازن ولتاژ اولیه ۱۰ ولت دارد و جریانی در مدار نیست.'
    }
]
